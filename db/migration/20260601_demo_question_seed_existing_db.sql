...
VALUES
    (990300000000000001, @demo_uid, 'company', '娣辨祴绉戞妧', DATE_ADD(CURDATE(), INTERVAL 14 DAY), 'urgent', '浼樺厛鍒锋繁娴嬬鎶€楂橀鍚庣棰橈紝鍑嗗涓€闈㈠埌鍔犻潰鐨勫畬鏁撮摼璺€?),
    (990300000000000002, @demo_uid, 'position', 'Java 鍚庣', DATE_ADD(CURDATE(), INTERVAL 14 DAY), 'high', '鍥寸粫 Spring銆丮ySQL銆丷edis銆並afka銆丣VM 鍋氫笓椤瑰鐩樸€?),
    (990300000000000003, @demo_uid, 'tag', 'Kafka', DATE_ADD(CURDATE(), INTERVAL 7 DAY), 'medium', '琛ラ綈娑堟伅鍫嗙Н銆佸箓绛夊拰閲嶈瘯姝讳俊妗堜緥銆?)
ON DUPLICATE KEY UPDATE
    uid = VALUES(uid),
...
VALUES
    (990310000000000001, @demo_uid, 990200000000000001, 'mastered', 1, '鍚岀被鏂规硶璋冪敤涓嶈蛋浠ｇ悊锛岃涓诲姩璇村嚭浜嬪姟杈圭晫涓轰粈涔堟斁鍦?service 缂栨帓灞傘€?, NULL, '鎴戜細鍏堣В閲?Spring AOP 浠ｇ悊鏈哄埗锛屽啀缁撳悎璁㈠崟缁撶畻椤圭洰璇存槑濡備綍鎶婁簨鍔″叆鍙ｆ斁鍒板簲鐢ㄦ湇鍔″眰锛屽苟琛ュ厖 rollbackFor 鍜屼紶鎾涓恒€?, 'S: 璁㈠崟缁撶畻瀛樺湪閮ㄥ垎鍐欏叆椋庨櫓锛汿: 姊崇悊浜嬪姟杈圭晫锛汚: 鎷嗗垎搴撳瓨銆佽鍗曘€佹祦姘村啓鍏ュ苟缁熶竴鐢卞簲鐢ㄦ湇鍔＄紪鎺掞紱R: 鍥炴粴璺緞娓呮櫚锛屽帇娴嬫棤鑴忔暟鎹€?, DATE_ADD(NOW(3), INTERVAL 10 DAY), NOW(3) - INTERVAL 1 DAY, 3, 10, NOW(3) - INTERVAL 8 DAY, NOW(3) - INTERVAL 1 DAY),
    (990310000000000002, @demo_uid, 990200000000000002, 'review', 1, '缂撳瓨涓€鑷存€т笉鑳藉彧鑳屽欢杩熷弻鍒狅紝瑕佽鍒犻櫎澶辫触琛ュ伩鍜岀儹鐐归噸寤恒€?, 'concept', '鏃佽矾缂撳瓨涓嬪厛鏇存柊 DB 鍐嶅垹缂撳瓨锛涘垹闄ゅけ璐ヨ繘鍏ラ噸璇曢槦鍒楋紝鐑偣 key 鐢ㄩ€昏緫杩囨湡鍜屼簰鏂ラ攣閲嶅缓銆?, 'S: 娲诲姩椤靛簱瀛樼紦瀛樺伓鍙戣剰璇伙紱T: 闄嶄綆涓嶄竴鑷寸獥鍙ｏ紱A: DB 鎴愬姛鍚庡垹缂撳瓨锛屽け璐ュ啓鍏ラ噸璇曚换鍔★紝鐑偣 key 鍔犵煭 TTL锛汻: 鎶曡瘔涓嬮檷锛岀紦瀛樺懡涓繚鎸佺ǔ瀹氥€?, NOW(3) - INTERVAL 2 HOUR, NOW(3) - INTERVAL 2 DAY, 2, 3, NOW(3) - INTERVAL 7 DAY, NOW(3) - INTERVAL 2 HOUR),
    (990310000000000003, @demo_uid, 990200000000000003, 'learning', 0, 'EXPLAIN 瀛楁瑕佽 type/key/rows/Extra锛屽啀钀藉埌绱㈠紩椤哄簭銆?, 'expression', '鎱?SQL 鎺掓煡浼氬厛鐢ㄦ參鏃ュ織瀹氫綅锛屽啀鐪?EXPLAIN 鍜屾暟鎹垎甯冿紝鏈€鍚庣敤缁勫悎绱㈠紩銆佽鐩栫储寮曟垨鍒嗛〉鏀瑰啓楠岃瘉鏁堟灉銆?, NULL, DATE_ADD(NOW(3), INTERVAL 1 DAY), NOW(3) - INTERVAL 3 DAY, 1, 2, NOW(3) - INTERVAL 6 DAY, NOW(3) - INTERVAL 1 DAY),
    (990310000000000004, @demo_uid, 990200000000000004, 'review', 1, 'Kafka 鍫嗙Н瑕佹寜 lag銆佹秷璐硅€楁椂銆佸け璐ラ噸璇曘€佸垎鍖哄€炬枩鍜屼笅娓歌€楁椂鎷嗐€?, 'project', '骞傜瓑鐢ㄤ笟鍔″敮涓€閿拰鏁版嵁搴撳敮涓€绾︽潫锛涘爢绉厛纭 lag 鍜屽鐞嗚€楁椂锛屽啀鍒ゆ柇鎵╁銆侀檺娴佽繕鏄笅娓搁檷绾с€?, 'S: 淇冮攢娑堟伅鍫嗙Н瀵艰嚧灞ョ害寤惰繜锛汿: 鎭㈠娑堣垂骞堕伩鍏嶉噸澶嶆墸鍑忥紱A: 澧炲姞骞傜瓑琛ㄣ€佽皟鏁存壒閲忔彁浜ゃ€侀殧绂绘參涓嬫父锛汻: lag 鍦?20 鍒嗛挓鍐呮仮澶嶅埌瀹夊叏姘翠綅銆?, NOW(3) - INTERVAL 1 HOUR, NOW(3) - INTERVAL 2 DAY, 2, 3, NOW(3) - INTERVAL 5 DAY, NOW(3) - INTERVAL 1 HOUR),
    (990310000000000005, @demo_uid, 990200000000000005, 'todo', 0, '闇€瑕佽ˉ涓€娈甸摼璺拷韪畾浣嶅閮ㄤ緷璧栬秴鏃剁殑鐪熷疄妗堜緥銆?, 'memory', NULL, NULL, NULL, NULL, 0, 1, NOW(3) - INTERVAL 5 DAY, NOW(3) - INTERVAL 5 DAY),
    (990310000000000006, @demo_uid, 990200000000000006, 'learning', 1, 'JVM 棰樿鎶?dump銆丟C 鏃ュ織鍜屽璞″紩鐢ㄩ摼杩炶捣鏉ャ€?, 'concept', '鎴戜細鍏堢湅 Full GC 鍚庤€佸勾浠ｅ洖鏀舵瘮渚嬶紝鍐嶆姄 heap dump锛岀敤 MAT 鐪?dominator tree 鍜?GC Roots锛岀‘璁ゆ槸鍚︽槸缂撳瓨鎴栭潤鎬侀泦鍚堟寔鏈夈€?, NULL, DATE_ADD(NOW(3), INTERVAL 2 DAY), NOW(3) - INTERVAL 1 DAY, 1, 2, NOW(3) - INTERVAL 2 DAY, NOW(3) - INTERVAL 1 DAY),
    (990310000000000007, @demo_uid, 990200000000000007, 'todo', 0, '鍑嗗鎶?OfferLab 棰樺簱鎼滅储浣滀负椤圭洰妗堜緥鏉ヨ銆?, NULL, '鎼滅储鎺ュ彛浼氱敤 ES 鍋氬叧閿瘝鍙洖锛孌B 鏌ヨ璇︽儏锛涚储寮曞け璐ヨ繘鍏ラ噸璇曚换鍔★紝鍓嶇灞曠ず浠诲姟鐘舵€佸拰闄嶇骇缁撴灉銆?, 'S: 棰樺簱澧為暱鍚庢悳绱㈠欢杩熷崌楂橈紱T: 淇濇寔鎼滅储浣撻獙锛汚: 寮曞叆绱㈠紩閲嶅缓鍜屽け璐ラ噸璇曪紱R: 鐑棬鍏抽敭璇嶅搷搴旂ǔ瀹氬湪鐧炬绉掔骇銆?, NULL, NULL, 0, 1, NOW(3) - INTERVAL 2 DAY, NOW(3)),
    (990310000000000008, @demo_uid, 990200000000000008, 'review', 1, 'STAR 琛ㄨ揪瑕侀噺鍖栫粨鏋滐紝涓嶈鍙鍋氫簡浼樺寲銆?, 'expression', '鎴戜細鐢ㄥ満鏅€佷换鍔°€佽鍔ㄣ€佺粨鏋滃洓娈靛洖绛旓紝骞舵妸缁撴灉钀藉埌閿欒鐜囥€丳99 寤惰繜鍜屾帓鏌ユ晥鐜囥€?, 'S: 鏍稿績鎺ュ彛鍦ㄦ椿鍔ㄦ湡闂磋秴鏃讹紱T: 鎴戣礋璐ｅ畾浣嶅苟闄嶄綆瓒呮椂锛汚: 鍔?tracing銆佷紭鍖栨參 SQL銆佺儹鐐圭紦瀛橀鐑紱R: P99 浠?1.8s 闄嶅埌 420ms锛岄敊璇巼浣庝簬 0.1%銆?, NOW(3) - INTERVAL 30 MINUTE, NOW(3) - INTERVAL 1 DAY, 1, 2, NOW(3) - INTERVAL 2 DAY, NOW(3) - INTERVAL 30 MINUTE)
ON DUPLICATE KEY UPDATE
    uid = VALUES(uid),
...
VALUES
    (990410000000000001, 990400000000000001, @demo_uid, 990200000000000002, 1, 'Redis 缂撳瓨鍜屾暟鎹簱鍙屽啓涓嶄竴鑷存椂锛屼綘浼氬浣曡璁℃洿鏂扮瓥鐣ワ紵', '鏃佽矾缂撳瓨銆佸垹闄ゅけ璐ヨˉ鍋垮拰鐑偣閲嶅缓銆?, '娣辨祴绉戞妧', 'Java 鍚庣', '涓€闈?, 'medium', '鍏堟洿鏂版暟鎹簱鍐嶅垹闄ょ紦瀛橈紝鍒犻櫎澶辫触鍐欏叆閲嶈瘯浠诲姟锛涚儹鐐?key 浣跨敤閫昏緫杩囨湡鍜屼簰鏂ラ噸寤恒€?, '杩橀渶瑕佽ˉ鍏呬负浠€涔堜笉鐩存帴鍏堝啓缂撳瓨銆?, 4),
    (990410000000000002, 990400000000000001, @demo_uid, 990200000000000004, 2, 'Kafka 娑堣垂绔浣曚繚璇佸箓绛夛紵濡傛灉鍑虹幇娑堟伅鍫嗙Н浣犱細鍏堢湅鍝簺鎸囨爣锛?, '骞傜瓑閿€佸敮涓€绾︽潫銆乴ag銆佸垎鍖哄€炬枩銆?, '娣辨祴绉戞妧', '鍚庣宸ョ▼甯?, '浜岄潰', 'hard', '鐢ㄤ笟鍔″敮涓€閿拰鍘婚噸琛ㄤ繚璇佸箓绛夛紱鍫嗙Н鍏堢湅 lag銆佹秷璐硅€楁椂銆佸け璐ラ噸璇曟瘮渚嬨€佸垎鍖哄€炬枩鍜屼笅娓歌€楁椂銆?, '鍥炵瓟瀹屾暣锛屼絾 STAR 妗堜緥鍙互鏇寸揣銆?, 4),
    (990410000000000003, 990400000000000001, @demo_uid, 990200000000000008, 3, '椤圭洰缁忓巻閲屼綘濡備綍鐢?STAR 璁叉竻涓€娆＄ǔ瀹氭€т紭鍖栵紵', 'STAR 鍥涙鍜岄噺鍖栫粨鏋溿€?, '娣辨祴绉戞妧', 'Java 鍚庣', '鎶€鏈姞闈?, 'easy', '鎴戜細鐢ㄥ満鏅€佷换鍔°€佽鍔ㄣ€佺粨鏋滃洓娈佃锛屾妸 P99銆侀敊璇巼鍜屾仮澶嶆椂闂翠綔涓虹粨鏋滄寚鏍囥€?, '琛ㄨ揪鏇撮『浜嗭紝涓嬩竴鐗堣鍔犱釜浜鸿础鐚竟鐣屻€?, 4)
ON DUPLICATE KEY UPDATE
    uid = VALUES(uid),
