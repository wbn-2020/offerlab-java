...
CREATE TABLE IF NOT EXISTS t_operation_slot (
    ...
    slot_status     VARCHAR(16)  NOT NULL DEFAULT 'DRAFT' COMMENT 'DRAFT / PREVIEW / PUBLISHED / OFFLINE',
    sort_order      INT          NOT NULL DEFAULT 100,
...
CREATE TABLE IF NOT EXISTS t_operation_topic (
    ...
    domain                  TINYINT      NULL,
    topic_status            VARCHAR(16)  NOT NULL DEFAULT 'DRAFT' COMMENT 'DRAFT / PREVIEW / PUBLISHED / OFFLINE',
    sort_order              INT          NOT NULL DEFAULT 100,
    starts_at               DATETIME(3)  NULL,
    ends_at                 DATETIME(3)  NULL,
    preview_token           VARCHAR(64)  NULL,
