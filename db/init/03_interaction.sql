...
CREATE TABLE t_int_comment (
    ...
    post_author_id  BIGINT       NOT NULL COMMENT '鍐椾綑锛氬笘瀛愪綔鑰?,
    ...
    comment_status  TINYINT      NOT NULL DEFAULT 1 COMMENT '1姝ｅ父 2瀹℃牳 3宸插垹',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='璇勮';

DROP TABLE IF EXISTS t_int_like;
CREATE TABLE t_int_like (
    id               BIGINT       NOT NULL PRIMARY KEY,
    user_id          BIGINT       NOT NULL,
    target_type      TINYINT      NOT NULL COMMENT '1甯栧瓙 2璇勮',
